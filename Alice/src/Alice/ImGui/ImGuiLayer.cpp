...
namespace Alice
{
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<KeyReleasedEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnKeyReleaseEvent));
		dispatcher.Dispatch<MouseScrolledEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
		dispatcher.Dispatch<MouseButtonPressedEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnMousePressedEvent));
		dispatcher.Dispatch<MouseButtonReleasedEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnMouseReleasedEvent));
		dispatcher.Dispatch<MouseMoveEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
		dispatcher.Dispatch<WindowResizeEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
		dispatcher.Dispatch<KeyTypedEvent>(ALICE_BIND_EVENT_FN(ImGuiLayer::OnKeyTypeEvent));
	}
